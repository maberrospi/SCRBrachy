...
class ImageData:
    def __init__(self, file):
        ...
        self.xaxis = np.arange(collection.ImagePositionPatient[0],
                               collection.PixelSpacing[0] * (self.volume.shape[1]) + collection.ImagePositionPatient[0],
                               collection.PixelSpacing[0])
        self.yaxis = np.arange(collection.ImagePositionPatient[1],
                               collection.PixelSpacing[1] * (self.volume.shape[0]) + collection.ImagePositionPatient[1],
